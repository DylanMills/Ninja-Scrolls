...
public class StandardizedBow : MonoBehaviour
{
    ...
    // PRIVATE VALUES
    [SerializeField] private float currentTime, lerpPercentage, startingAngleDown, startingAngleUp, currentAngleDown, currentAngleUp;
...
[SerializeField]    private Transform lastProjectileTransform;
    ...
    void Update()
    {
        PullAmount = -controller.totalScroll/100;
        // STATE 1 - Pulling the string - Default Trigger is left mouse click
        if (controller.weaponLoaded)
        {
